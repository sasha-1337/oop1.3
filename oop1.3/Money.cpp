...
double Money::get_sum1(Money& a) { return (a.g1000 * 1000. + a.g500 * 500. + a.g200 * 200. + a.g100 * 100. + a.g50 * 50. +
										   a.g20 * 20. + a.g10 * 10. + a.g5 * 5. + a.g2 * 2. + a.g1 * 1. + a.c50 * 0.50 + a.c10 * 0.1); }

double Money::get_sum2(Money& b) { return (b.g1000 * 1000. + b.g500 * 500. + b.g200 * 200. + b.g100 * 100. + b.g50 * 50. +
...
void Money::Divide(Money& a, Money& b) const
{
	...
	{
		cout << " DIVIDE = " << setprecision(3) << x.get_sum1(a) / x.get_sum2(b) << endl;
	}
	if (x.get_sum1(a) < x.get_sum2(b))
	{
		cout << " DIVIDE = " << setprecision(3) << x.get_sum2(a) / x.get_sum1(b) << endl;
	}
}
